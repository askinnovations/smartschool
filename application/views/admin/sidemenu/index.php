...
<div id="menuModal" class="modal fade" role="dialog">
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         <form class="form-horizontal" method="POST" action="<?php echo site_url("admin/sidemenu/add_menu") ?>" id="form_add_menu" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="modal-body">
               <div class="box-body pt0 pb0">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-3" for="title"><?php echo $this->lang->line('title'); ?></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="title" name="title" placeholder="<?php echo $this->lang->line('enter_title'); ?>">
                    </div>
                  </div>
                  <!-- Image Upload -->
                  <div class="form-group">
                    <label class="control-label col-sm-3" for="image"><?php echo $this->lang->line('image'); ?></label>
                    <div class="col-sm-9">
                        <input type="file" class="form-control" id="image" class="filestyle form-control" value="name" data-height="40" name="image">
                        <small class="text-secondary">Allowed: jpg, jpeg, png, gif</small>
