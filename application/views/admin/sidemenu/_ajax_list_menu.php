                     ...
                     <div class="panel panel-default" id="<?php echo $menu_value->id; ?>">
                        <div class="panel-heading" role="tab" id="headingOne">
                           <h4 class="panel-title relative">
                              ...
                              <a href="javascript:void(0);" data-record-id="<?php echo $menu_value->id; ?>" class="btn btn-xs edit_menu more-less-right" data-toggle="tooltip"
                        ...
                        <div id="collapse<?php echo $menu_value->id ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                           <div class="panel-body">
                              <button class="btn btn-primary btn-xs pull-right mb10 add_sub_menu" data-menu-id="<?php echo $menu_value->id ?>" > <?php echo $this->lang->line('add_sub_menu'); ?></button>
                              <div class="clearfix"></div>
                              <?php
                                 if (!empty($menu_value->submenus)) {
                                     ?>
