...
if ($gmeet_value->status == 0) { 
            ?>
                                                    <a href="<?php echo base_url();?>admin/gmeet/start/<?php echo $gmeet_value->id."/class"; ?>" class="btn label-success btn-xs start-mr-20" target="_blank" onclick="window.open('<?php echo $gmeet_value->url; ?>', '_blank'); return false;">
