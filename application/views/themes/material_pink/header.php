<header>
   ...
   <style type="text/css">
    ...
    /* Desktop header show by default */
    .desktop-header {
      display: block;
    }
    ...
    @media (max-width: 768px) {
      ...
      /* Mobile toggle button styling */
        ...
        /* Mobile header background to make lines visible */
        .mobile-header {
        background-color: #3D2DB3; /* Your brand purple */
        display: flex;
        align-items: center;
        justify-content: space-between;
        padding: 10px 15px;
   ...
   <!-- ✅ MOBILE HEADER -->
        <div class="mobile-header">
                ...
                <div class="d-flex align-items-center">
                    <img src="<?php echo base_url('uploads/footer/CRB/Ellipse 15.png'); ?>" alt="Profile" class="rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px;">
                    <span style="font-weight: 500; font-size: 14px; color:#fff;">Hi, Yug Puttichai</span>
                </div>
                
                <!-- Notification Bell -->
                <a href="#" style="margin-left: 40%; position: relative;">
                    <i class="fa fa-bell" style="font-size: 18px; color: #fff;"></i>
                    <span style="position: absolute; top: -5px; right: 10px; background-color: red; color: white; font-size: 10px; padding: 2px 5px; border-radius: 50%;">3</span>
                </a>
                <div class="navbar-header">
                  <button type="button" class="navbar-toggle collapsed" style="color:black" data-toggle="collapse" data-target="#navbar-collapse-3">
